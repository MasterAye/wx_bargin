// const ApiRootUrl = "http://10.0.0.19:8360/api/";
// const ApiRootUrl = "http://111.231.255.62:8360/api/";
const ApiRootUrl = "https://dstar.xin/kanjia/";
const ImgServer = "https://dstar.xin";
module.exports = {
    //砍价口号
    slogan_share:"关系好不好，一刀见分晓！",
    slogan_index:"砍价有神器",
    ImgServer: ImgServer,
    OrdersStatus: ApiRootUrl + "order/ordersStatus",//订单状态
    UploadRefundImg:ApiRootUrl+"upload/refundImg",
