...
Page({
    ...
    refund(e) {
        ...
        if (that.data.refund_type == 0) { //未发货之前退款
            ...
            console.log('999999999999999999999999:',that.data.refund_uploadimg) //退款凭证图片
            console.log(that.data.refund_resond) //退款原因
            ...
            success: function(res) {
                ...
                wx.uploadFile({
                    ...
                    success: function(data) {
                        console.log("didPressChooesImage data:", data)
                        if (data.statusCode == 200) {
                            const res = JSON.parse(data.data)
                            console.log("res:", res.data.code)
                            if (res.data.code == 200) {
                                let obj = {}
                                // obj.img = api.ImgServer + res.data.path
